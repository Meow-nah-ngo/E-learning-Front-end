...
export default function SearchBar({ value, onChange, placeholder = "ค้นหาคอร์สเรียน..." }: SearchBarProps) {
  return (
    <div className="flex items-center w-full max-w-[fill] bg-white border border-neutral/60 rounded-full py-[20px] px-[32px] shadow-xs focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/10 transition-all duration-200">
